class InstructionBase:
    ...
    def define_disassembly(cls):
        ...
        cls._instructions[cls.OP_JMPZT] = "JPZ T"
        cls._instructions[cls.OP_JMPZA] = "JPZ A"
        cls._instructions[cls.OP_JMPZU] = "JPZ U"
        cls._instructions[cls.OP_JMPZN] = "JPZ N"
        cls._instructions[cls.OP_JMPZABS] = "JPZ {0}"
        cls._instructions[cls.OP_JMPZABS|1] = "JPZ {0}"
        cls._instructions[cls.OP_JMPZABS|2] = "JPZ {0}"
        cls._instructions[cls.OP_JMPZABS|3] = "JPZ {0}"
        ...
        cls._instructions[cls.OP_JMPCT] = "JPC T"
        cls._instructions[cls.OP_JMPCA] = "JPC A"
        cls._instructions[cls.OP_JMPCU] = "JPC U"
        cls._instructions[cls.OP_JMPCN] = "JPC N"
        cls._instructions[cls.OP_JMPCABS] = "JPC {0}"
        cls._instructions[cls.OP_JMPCABS|1] = "JPC {0}"
        cls._instructions[cls.OP_JMPCABS|2] = "JPC {0}"
        cls._instructions[cls.OP_JMPCABS|3] = "JPC {0}"
